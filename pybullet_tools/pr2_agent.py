    ...
    stream_map = {
        ...
        'inverse-reachability': from_gen_fn(
            get_ik_gen(p, collisions=c, teleport=t, ir_only=True, custom_limits=l,
                       learned=False, verbose=False, visualize=True)),
        'inverse-kinematics': from_fn(get_ik_fn(p, collisions=motion_collisions, teleport=t,
                                                verbose=False, visualize=True, ACONF=False)),
