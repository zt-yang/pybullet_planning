(define (stream mobile-robot-tamp)
  ...
  ;; -------------------------------------------------------------------
    ...
    (:stream plan-base-pull-handle
      ...
      :domain (and (GraspHandle ?a ?o ?p1 ?g ?q1 ?aq1) (Position ?o ?p2) (IsSampledPosition ?o ?p1 ?p2) (UnattachedJoint ?o))
